const express = require('express-prometheus-middleware/src/node_modules/express');
const Prometheus = require('prom-client');
const ResponseTime = require('express-prometheus-middleware/src/node_modules/response-time');

const {
  requestCountGenerator,
  requestDurationGenerator,
} = require('express-prometheus-middleware/src/metrics');

const {
  normalizeStatusCode,
  normalizePath,
} = require('express-prometheus-middleware/src/normalizers');
...
module.exports = (userOptions = {}) => {
  ...
  if (options.collectGCMetrics) {
    ...
    try {
      ...
      const gcStats = require('express-prometheus-middleware/src/node_modules/prometheus-gc-stats');
